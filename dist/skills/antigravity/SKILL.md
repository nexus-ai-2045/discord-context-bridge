...
ssot_commit: 4bf39abe963d799fb95c9ce2706aa512e5fbe0c7
...
contract_checksum: 76389779e0433e94e22be1cd2a76baf2705ad729b099e6e34d4d908922907337
generated_at: 2026-07-07T20:53:40+00:00
...
7. Chrome visible fallback / OCR region は、DCB 内の safe fallback reason と tab guard の結果を返した後、ユーザーが明示した場合だけ使う。ここでいう明示は、そのターンで「Computer Use 的な画面操作」「SendKeys / AppActivate / click / scroll」「スクショ取得」「Chromeを勝手に開く・遷移する」のどれを許可するかが分かる形に限定する。
