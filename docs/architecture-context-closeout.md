...
4. GitHub account / remote owner / git author は `scripts/gh_guard.py` と PR readiness で確認し、名義事故を Git 操作前に止める。
5. private adapter producer contract は別 layer で管理し、public core には stdout contract と metadata schema だけを渡す。
